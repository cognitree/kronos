...
public class WebServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new WebServer().start(mode, host, port, resourceBase, contextPath, descriptorFile);
    }

    private void start(String mode, String host, Integer port, String resourceBase, String contextPath, String descriptorFile) throws Exception {
        logger.info("Starting Kronos web server with params mode {}, host {}, port {}, resource base {}, " +
