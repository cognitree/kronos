...
public class KafkaStatusProducer implements Producer<TaskStatus> {
    private static final Logger logger = LoggerFactory.getLogger(KafkaStatusProducer.class);
    ...
    public KafkaStatusProducer(ObjectNode config) {
